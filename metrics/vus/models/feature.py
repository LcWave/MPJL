...
import sys
import types
fake_gpu_stump = types.ModuleType("gpu_stump")
fake_gpu_stump.gpu_stump = None  # add a dummy placeholder
sys.modules['stumpy.gpu_stump'] = fake_gpu_stump

fake_gpu_aamp = types.ModuleType("gpu_aamp")
fake_gpu_aamp.gpu_aamp = None
sys.modules['stumpy.gpu_aamp'] = fake_gpu_aamp
